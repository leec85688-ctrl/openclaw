...
- Sub-agent context only injects the reduced bootstrap allowlist: `AGENTS.md`, `SOUL.md`, `TOOLS.md`, `IDENTITY.md`, and `USER.md` (`HEARTBEAT.md`, `BOOTSTRAP.md`, and `MEMORY.md` stay out).
